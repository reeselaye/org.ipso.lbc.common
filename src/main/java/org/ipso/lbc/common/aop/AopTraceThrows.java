...
@Aspect
public class AopTraceThrows implements ThrowsAdvice {

    private static Logger logger = LoggerFactory.getLogger("error.exception.aop");


    public void afterThrowing(Method m, Object[] os, Object target, Throwable throwable) {
        logger.error(target.toString(),throwable);
    }
}
